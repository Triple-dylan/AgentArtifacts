...
> 🔧 **Utility** · Guardrail policies and safety templates
...
It covers core use cases for **Guardrails YAML Kit** and works with any major LLM.
...
```json
{
  ...
  "title": "Guardrails YAML Kit",
  "description": "Guardrail policies and safety templates",
  "type": "object",
...
*Full version available at [agentartifacts.io/products/utility-guardrails-yaml](https://agentartifacts.io/products/utility-guardrails-yaml)*
