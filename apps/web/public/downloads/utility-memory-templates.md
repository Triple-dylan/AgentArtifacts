...
> 🔧 **Utility** · Memory templates for context persistence
...
It covers core use cases for **Memory Template Library** and works with any major LLM.
...
```json
{
  ...
  "title": "Memory Template Library",
  "description": "Memory templates for context persistence",
  "type": "object",
...
*Full version available at [agentartifacts.io/products/utility-memory-templates](https://agentartifacts.io/products/utility-memory-templates)*
