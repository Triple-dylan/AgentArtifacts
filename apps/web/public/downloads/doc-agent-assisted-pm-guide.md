# Agent-Assisted PM Guide
*Free download — Agent Artifacts*

> Doc · Guide for product managers on leveraging AI agents for research, specs, and tracking
...
It covers core use cases for **Agent-Assisted PM Guide** and works with any major LLM.

**Compatible with:** openai | anthropic | cursor | langchain
...
## About This Guide
Guide for product managers on leveraging AI agents for research, specs, and tracking
