# Marketing Campaign Prompt Suite
**Product ID:** `AA-PRM-MKT-CAMPAIGN-SUITE-003`  
...
Campaign planning prompts for teams
...
```
Analyse the following marketing campaign in depth.
...
```
Process the following marketing campaign and return a structured JSON response.
...
```
Compare the following marketing campaign options and recommend the best choice.
...
```
Review the following marketing campaign and identify the top 5 improvements.
...
```
Generate a complete, professional marketing campaign for the following specification.
...
```
Validate the following marketing campaign against best practices and requirements.
...
```
Adapt the following marketing campaign for a different audience or context.
...
```
Summarise the following marketing campaign for an executive audience.
...
```
Review and improve the following marketing campaign draft.
...
```
Generate 15 clarifying questions about the following marketing campaign.
...
```
Prioritise the following marketing campaign items using the given criteria.
...
```
Write a professional report on the following marketing campaign.
...
```json
{
  "product_id": "AA-PRM-MKT-CAMPAIGN-SUITE-003",
  "slug": "prompt-marketing-campaign-suite",
  "name": "Marketing Campaign Prompt Suite",
  "category": "prompt",
  "subcategory": "prompt_suite",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-marketing-campaign-suite.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
