...
**Product ID:** `AA-SKL-FIN-INVOICEPRO-066`  
...
Extract, validate, and route invoice data with structured output and approval logic

This skill module provides a standardised interface for integrating AI-powered
`invoice processing` capabilities into any agent workflow.
...
```markdown
# Skill: Invoice Processing Skill v1.0
...
```
You are a specialised AI skill module for invoice processing.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for invoice processing.
...
Save as `.claude/skills/skill-invoice-processing-pro.md` and invoke with `/invoice-processing-pro`
...
```json
{
  "product_id": "AA-SKL-FIN-INVOICEPRO-066",
  "skill_name": "Invoice Processing Skill",
  "version": "1.0.0",
  "category": "skill",
