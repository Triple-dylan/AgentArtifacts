# Lead Scoring Skill
**Product ID:** `AA-SKL-SLS-LEADSCORE-PRO-045`  
...
Structured skill for AI-driven lead qualification and ICP fit scoring

This skill module provides a standardised interface for integrating AI-powered
`lead scoring` capabilities into any agent workflow.
...
```
You are a specialised AI skill module for lead scoring.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for lead scoring.
...
Save as `.claude/skills/skill-lead-scoring-pro.md` and invoke with `/lead-scoring-pro`
...
```json
{
  "product_id": "AA-SKL-SLS-LEADSCORE-PRO-045",
  "skill_name": "Lead Scoring Skill",
  "version": "1.0.0",
  "category": "skill",
