# Data Metadata Schema Pack
**Product ID:** `AA-UTL-DAT-METASCHEMA-CORE-079`  
...
JSON schemas for datasets, metrics, dimensions, and pipeline lineage metadata
...
```json
{
  ...
  "title": "Data Metadata Schema Pack",
  "description": "JSON schemas for datasets, metrics, dimensions, and pipeline lineage metadata",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Data Metadata Schema Pack Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
