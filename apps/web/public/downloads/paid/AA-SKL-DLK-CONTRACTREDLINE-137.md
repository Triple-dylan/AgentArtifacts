# Contract Redline Suggestion Skill
**Product ID:** `AA-SKL-DLK-CONTRACTREDLINE-137`  
...
Suggests redlines for commercial terms, liability caps, and payment milestones in SaaS contracts

This skill module provides a standardised interface for integrating AI-powered
`contract redline suggestion` capabilities into any agent workflow.
...
```markdown
# Skill: Contract Redline Suggestion Skill v1.0
...
```
You are a specialised AI skill module for contract redline suggestion.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for contract redline suggestion.
...
Save as `.claude/skills/skill-contract-redline-module.md` and invoke with `/contract-redline-module`
...
```json
{
  "product_id": "AA-SKL-DLK-CONTRACTREDLINE-137",
  "skill_name": "Contract Redline Suggestion Skill",
  "version": "1.0.0",
  "category": "skill",
