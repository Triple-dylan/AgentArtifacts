# Schema Markup Generator Utility
**Product ID:** `AA-UTL-SEO-SCHEMAMARKUP-156`  
...
Generates structured data JSON-LD for articles, products, FAQs, and local business pages
...
```json
{
  ...
  "title": "Schema Markup Generator Utility",
  "description": "Generates structured data JSON-LD for articles, products, FAQs, and local business pages",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Schema Markup Generator Utility Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
