# Financial Data Schema Utility
**Product ID:** `AA-UTL-FIN2-FINSCHEMA-132`  
...
Canonical schema definitions for financial statements, KPIs, and segment reporting
...
```json
{
  ...
  "title": "Financial Data Schema Utility",
  "description": "Canonical schema definitions for financial statements, KPIs, and segment reporting",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Financial Data Schema Utility Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
