# Board Narrative Prompt Pack
**Product ID:** `AA-PRM-FIN2-BOARDNARRATIVE-126`  
...
Prompts for crafting concise board-ready financial narratives from raw model outputs
...
```
Analyse the following board narrative in depth.
...
```
Process the following board narrative and return a structured JSON response.
...
```
Compare the following board narrative options and recommend the best choice.
...
```
Review the following board narrative and identify the top 5 improvements.
...
```
Generate a complete, professional board narrative for the following specification.
...
```
Validate the following board narrative against best practices and requirements.
...
```
Adapt the following board narrative for a different audience or context.
...
```
Summarise the following board narrative for an executive audience.
...
```
Review and improve the following board narrative draft.
...
```
Generate 15 clarifying questions about the following board narrative.
...
```
Prioritise the following board narrative items using the given criteria.
...
```
Write a professional report on the following board narrative.
...
```json
{
  "product_id": "AA-PRM-FIN2-BOARDNARRATIVE-126",
  "slug": "prompt-board-narrative-pack",
  "name": "Board Narrative Prompt Pack",
  "category": "prompt",
  "subcategory": "prompt_pack",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-board-narrative-pack.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
