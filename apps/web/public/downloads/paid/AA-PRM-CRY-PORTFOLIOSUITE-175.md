# Crypto Portfolio Strategy Prompt Suite
**Product ID:** `AA-PRM-CRY-PORTFOLIOSUITE-175`  
...
End-to-end suite for portfolio construction, rebalancing logic, and risk budgeting in crypto

This pack covers: `prompt suite` workflows.
...
```
Analyse the following crypto portfolio strategy in depth.
...
```
Process the following crypto portfolio strategy and return a structured JSON response.
...
```
Compare the following crypto portfolio strategy options and recommend the best choice.
...
```
Review the following crypto portfolio strategy and identify the top 5 improvements.
...
```
Generate a complete, professional crypto portfolio strategy for the following specification.
...
```
Validate the following crypto portfolio strategy against best practices and requirements.
...
```
Adapt the following crypto portfolio strategy for a different audience or context.
...
```
Summarise the following crypto portfolio strategy for an executive audience.
...
```
Review and improve the following crypto portfolio strategy draft.
...
```
Generate 15 clarifying questions about the following crypto portfolio strategy.
...
```
Prioritise the following crypto portfolio strategy items using the given criteria.
...
```
Write a professional report on the following crypto portfolio strategy.
...
```json
{
  "product_id": "AA-PRM-CRY-PORTFOLIOSUITE-175",
  "slug": "prompt-crypto-portfolio-suite",
  "name": "Crypto Portfolio Strategy Prompt Suite",
  "category": "prompt",
  "subcategory": "prompt_suite",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-crypto-portfolio-suite.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
