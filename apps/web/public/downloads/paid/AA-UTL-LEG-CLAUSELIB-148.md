# Legal Clause Library Utility
**Product ID:** `AA-UTL-LEG-CLAUSELIB-148`  
...
Curated library of 200+ fallback and standard clauses organized by contract type and jurisdiction
...
```json
{
  ...
  "title": "Legal Clause Library Utility",
  "description": "Curated library of 200+ fallback and standard clauses organized by contract type and jurisdiction",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Legal Clause Library Utility Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
