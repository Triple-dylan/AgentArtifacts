...
**Product ID:** `AA-PRM-HEALTH-DOCNOTE-196`
...
Prompts for structuring clinical notes, discharge summaries, and referral letters
...
Analyse the following clinical documentation prompts scenario in depth.
