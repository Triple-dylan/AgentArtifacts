...
**Product ID:** `AA-SKL-PMG-FEATUREGATE-PRO-221`
...
Skill for evaluating feature flags, rollout criteria, and experiment analysis
...
## Configuration
```yaml
skill_id: AA-SKL-PMG-FEATUREGATE-PRO-221
version: 1.0.0
mode: production
...
Extract relevant features for feature gating skill processing.
