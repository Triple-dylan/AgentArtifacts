# Feature Scoring & Prioritization Skill
**Product ID:** `AA-SKL-PMG-FEATURESCORE-160`  
...
Applies RICE, ICE, and weighted scoring models to your feature backlog with justifications

This skill module provides a standardised interface for integrating AI-powered
`feature scoring & prioritization` capabilities into any agent workflow.
...
```markdown
# Skill: Feature Scoring & Prioritization Skill v1.0
...
```
You are a specialised AI skill module for feature scoring & prioritization.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for feature scoring & prioritization.
...
Save as `.claude/skills/skill-feature-scoring-module.md` and invoke with `/feature-scoring-module`
...
```json
{
  "product_id": "AA-SKL-PMG-FEATURESCORE-160",
  "skill_name": "Feature Scoring & Prioritization Skill",
  "version": "1.0.0",
  "category": "skill",
