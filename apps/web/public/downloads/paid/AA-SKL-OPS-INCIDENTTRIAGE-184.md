# Incident Triage & Routing Skill
**Product ID:** `AA-SKL-OPS-INCIDENTTRIAGE-184`  
...
Classifies incoming alerts by severity, maps to runbooks, and routes to on-call responders

This skill module provides a standardised interface for integrating AI-powered
`incident triage & routing` capabilities into any agent workflow.
...
```markdown
# Skill: Incident Triage & Routing Skill v1.0
...
```
You are a specialised AI skill module for incident triage & routing.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for incident triage & routing.
...
Save as `.claude/skills/skill-incident-triage-module.md` and invoke with `/incident-triage-module`
...
```json
{
  "product_id": "AA-SKL-OPS-INCIDENTTRIAGE-184",
  "skill_name": "Incident Triage & Routing Skill",
  "version": "1.0.0",
  "category": "skill",
