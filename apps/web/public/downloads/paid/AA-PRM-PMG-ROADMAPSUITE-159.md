# Roadmap Planning Prompt Suite
**Product ID:** `AA-PRM-PMG-ROADMAPSUITE-159`  
...
Covers opportunity sizing, prioritization frameworks, and quarterly roadmap narrative prompts
...
```
Analyse the following roadmap planning in depth.
...
```
Process the following roadmap planning and return a structured JSON response.
...
```
Compare the following roadmap planning options and recommend the best choice.
...
```
Review the following roadmap planning and identify the top 5 improvements.
...
```
Generate a complete, professional roadmap planning for the following specification.
...
```
Validate the following roadmap planning against best practices and requirements.
...
```
Adapt the following roadmap planning for a different audience or context.
...
```
Summarise the following roadmap planning for an executive audience.
...
```
Review and improve the following roadmap planning draft.
...
```
Generate 15 clarifying questions about the following roadmap planning.
...
```
Prioritise the following roadmap planning items using the given criteria.
...
```
Write a professional report on the following roadmap planning.
...
```json
{
  "product_id": "AA-PRM-PMG-ROADMAPSUITE-159",
  "slug": "prompt-roadmap-planning-suite",
  "name": "Roadmap Planning Prompt Suite",
  "category": "prompt",
  "subcategory": "prompt_suite",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-roadmap-planning-suite.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
