...
**Product ID:** `AA-PRM-DAT-SQLGEN-193`
...
Prompts for generating optimised SQL queries from natural language descriptions
...
Analyse the following sql query generator prompts scenario in depth.
