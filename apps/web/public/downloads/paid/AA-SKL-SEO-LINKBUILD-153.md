...
**Product ID:** `AA-SKL-SEO-LINKBUILD-153`  
...
Identifies link opportunities and generates personalized outreach emails for link acquisition

This skill module provides a standardised interface for integrating AI-powered
`link building outreach` capabilities into any agent workflow.
...
```markdown
# Skill: Link Building Outreach Skill v1.0
...
```
You are a specialised AI skill module for link building outreach.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for link building outreach.
...
Save as `.claude/skills/skill-link-building-module.md` and invoke with `/link-building-module`
...
```json
{
  "product_id": "AA-SKL-SEO-LINKBUILD-153",
  "skill_name": "Link Building Outreach Skill",
  "version": "1.0.0",
  "category": "skill",
