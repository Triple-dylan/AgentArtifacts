# Push Notification Orchestration Skill
**Product ID:** `AA-SKL-MOB-PUSHNOTIF-121`  
...
Skill for segmenting, scheduling, and A/B testing push notifications via FCM and APNs

This skill module provides a standardised interface for integrating AI-powered
`push notification orchestration` capabilities into any agent workflow.
...
```markdown
# Skill: Push Notification Orchestration Skill v1.0
...
```
You are a specialised AI skill module for push notification orchestration.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for push notification orchestration.
...
Save as `.claude/skills/skill-push-notification-module.md` and invoke with `/push-notification-module`
...
```json
{
  "product_id": "AA-SKL-MOB-PUSHNOTIF-121",
  "skill_name": "Push Notification Orchestration Skill",
  "version": "1.0.0",
  "category": "skill",
