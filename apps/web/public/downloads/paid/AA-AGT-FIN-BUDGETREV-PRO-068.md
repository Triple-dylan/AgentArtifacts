# Budget Review Agent
**Product ID:** `AA-AGT-FIN-BUDGETREV-PRO-068`  
...
Reviews budget submissions, flags overages, and generates executive summary commentary
...
```json
{
  "agent_id": "AA-AGT-FIN-BUDGETREV-PRO-068",
  "name": "Budget Review Agent",
  "version": "1.0.0",
  "description": "Reviews budget submissions, flags overages, and generates executive summary commentary",
  "category": "agent",
  "execution_mode": "none",
...
```
You are Budget Review Agent, a specialised AI agent for budget review tasks.

Your capabilities:
- Analyse and process budget review-related inputs
...
You have access to the Budget Review Agent agent capability.
When asked to perform budget review tasks, follow the workflow defined in this package.
```
