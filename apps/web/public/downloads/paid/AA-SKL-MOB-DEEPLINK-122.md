# Universal Deep Link Handler Skill
**Product ID:** `AA-SKL-MOB-DEEPLINK-122`  
...
Generates deep link routing tables and handlers for iOS Universal Links and Android App Links

This skill module provides a standardised interface for integrating AI-powered
`universal deep link handler` capabilities into any agent workflow.
...
```markdown
# Skill: Universal Deep Link Handler Skill v1.0
...
```
You are a specialised AI skill module for universal deep link handler.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for universal deep link handler.
...
Save as `.claude/skills/skill-deep-link-handler.md` and invoke with `/deep-link-handler`
...
```json
{
  "product_id": "AA-SKL-MOB-DEEPLINK-122",
  "skill_name": "Universal Deep Link Handler Skill",
  "version": "1.0.0",
  "category": "skill",
