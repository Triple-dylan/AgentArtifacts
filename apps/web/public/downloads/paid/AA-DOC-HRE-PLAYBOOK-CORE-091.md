# HR AI Playbook
**Product ID:** `AA-DOC-HRE-PLAYBOOK-CORE-091`  
...
Guide for deploying AI in HR: recruiting automation, performance reviews, and compliance

This guide provides actionable, implementation-focused coverage of
`hr ai playbook` for AI-powered workflows.

---

## Chapter 1 — Foundations

### What is Hr Ai Playbook?
