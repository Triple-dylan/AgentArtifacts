...
**Product ID:** `AA-AGT-HEALTH-CLINASSIST-PRO-229`
...
Agent for clinical documentation review, terminology lookup, and referral drafting
...
## Configuration
```yaml
agent_id: AA-AGT-HEALTH-CLINASSIST-PRO-229
version: 1.0.0
type: agent_config
