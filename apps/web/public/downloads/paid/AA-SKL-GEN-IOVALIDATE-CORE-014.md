# IO Validation Skill Module
**Product ID:** `AA-SKL-GEN-IOVALIDATE-CORE-014`  
...
`io validation` capabilities into any agent workflow.
...
```markdown
# Skill: IO Validation Skill Module v1.0
...
```
You are a specialised AI skill module for io validation.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for io validation.
...
Save as `.claude/skills/skill-io-validate.md` and invoke with `/io-validate`
...
```json
{
  "product_id": "AA-SKL-GEN-IOVALIDATE-CORE-014",
  "skill_name": "IO Validation Skill Module",
  "version": "1.0.0",
  "category": "skill",
