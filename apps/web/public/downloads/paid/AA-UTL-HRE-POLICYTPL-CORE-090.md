# HR Policy Templates
**Product ID:** `AA-UTL-HRE-POLICYTPL-CORE-090`  
...
Structured Markdown templates for PTO, remote work, code of conduct, and review policies
...
```json
{
  ...
  "description": "Structured Markdown templates for PTO, remote work, code of conduct, and review policies",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "HR Policy Templates Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
