...
**Product ID:** `AA-SKL-WEB-PERFAUDIT-114`  
...
Analyzes codebase for Core Web Vitals issues and generates targeted optimization patches

This skill module provides a standardised interface for integrating AI-powered
`web performance audit` capabilities into any agent workflow.
...
```markdown
# Skill: Web Performance Audit Skill v1.0
...
```
You are a specialised AI skill module for web performance audit.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for web performance audit.
...
Save as `.claude/skills/skill-web-perf-audit.md` and invoke with `/web-perf-audit`
...
```json
{
  "product_id": "AA-SKL-WEB-PERFAUDIT-114",
  "skill_name": "Web Performance Audit Skill",
  "version": "1.0.0",
  "category": "skill",
