...
**Product ID:** `AA-PRM-LEG-CONTRACTREVIEW-141`  
...
30 prompts for first-pass contract review covering risk flags, missing clauses, and summaries
...
```
Analyse the following contract review in depth.
...
```
Process the following contract review and return a structured JSON response.
...
```
Compare the following contract review options and recommend the best choice.
...
```
Review the following contract review and identify the top 5 improvements.
...
```
Generate a complete, professional contract review for the following specification.
...
```
Validate the following contract review against best practices and requirements.
...
```
Adapt the following contract review for a different audience or context.
...
```
Summarise the following contract review for an executive audience.
...
```
Review and improve the following contract review draft.
...
```
Generate 15 clarifying questions about the following contract review.
...
```
Prioritise the following contract review items using the given criteria.
...
```
Write a professional report on the following contract review.
...
```json
{
  "product_id": "AA-PRM-LEG-CONTRACTREVIEW-141",
  "slug": "prompt-contract-review-pack",
  "name": "Contract Review Prompt Pack",
  "category": "prompt",
  "subcategory": "prompt_pack",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-contract-review-pack.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
