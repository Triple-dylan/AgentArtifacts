...
**Product ID:** `AA-UTL-ENG-APIDOC-CORE-060`  
...
Markdown templates for REST, GraphQL, and gRPC API documentation
...
```json
{
  ...
  "description": "Markdown templates for REST, GraphQL, and gRPC API documentation",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "API Documentation Templates Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
