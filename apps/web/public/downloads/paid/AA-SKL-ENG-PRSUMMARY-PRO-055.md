# PR Summary Skill
**Product ID:** `AA-SKL-ENG-PRSUMMARY-PRO-055`  
...
Auto-summarize pull requests with diff analysis, risk flags, and reviewer guidance

This skill module provides a standardised interface for integrating AI-powered
`pr summary` capabilities into any agent workflow.
...
```
You are a specialised AI skill module for pr summary.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for pr summary.
...
Save as `.claude/skills/skill-pr-summary-pro.md` and invoke with `/pr-summary-pro`
...
```json
{
  "product_id": "AA-SKL-ENG-PRSUMMARY-PRO-055",
  "skill_name": "PR Summary Skill",
  "version": "1.0.0",
  "category": "skill",
