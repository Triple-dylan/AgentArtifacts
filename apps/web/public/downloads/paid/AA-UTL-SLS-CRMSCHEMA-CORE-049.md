# CRM Data Schema Pack
**Product ID:** `AA-UTL-SLS-CRMSCHEMA-CORE-049`  
...
JSON schemas for contacts, deals, activities, and pipeline stage transitions
...
```json
{
  ...
  "title": "CRM Data Schema Pack",
  "description": "JSON schemas for contacts, deals, activities, and pipeline stage transitions",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "CRM Data Schema Pack Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
