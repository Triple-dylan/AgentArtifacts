...
**Product ID:** `AA-SKL-DAT-ANOMALY-PRO-075`  
...
Structured skill for statistical anomaly detection with root cause hypothesis generation

This skill module provides a standardised interface for integrating AI-powered
`anomaly detection` capabilities into any agent workflow.
...
```markdown
# Skill: Anomaly Detection Skill v1.0
...
```
You are a specialised AI skill module for anomaly detection.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for anomaly detection.
...
Save as `.claude/skills/skill-anomaly-detection-pro.md` and invoke with `/anomaly-detection-pro`
...
```json
{
  "product_id": "AA-SKL-DAT-ANOMALY-PRO-075",
  "skill_name": "Anomaly Detection Skill",
  "version": "1.0.0",
  "category": "skill",
