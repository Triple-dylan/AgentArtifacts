# Interview Guide Prompt Suite
**Product ID:** `AA-PRM-HRE-INTERVIEW-SUITE-084`  
...
Chained prompts for structured interview question generation and evaluation rubrics
...
```
Analyse the following interview in depth.
...
```
Process the following interview and return a structured JSON response.
...
```
Compare the following interview options and recommend the best choice.
...
```
Review the following interview and identify the top 5 improvements.
...
```
Generate a complete, professional interview for the following specification.
...
```
Validate the following interview against best practices and requirements.
...
```
Adapt the following interview for a different audience or context.
...
```
Summarise the following interview for an executive audience.
...
```
Review and improve the following interview draft.
...
```
Generate 15 clarifying questions about the following interview.
...
```
Prioritise the following interview items using the given criteria.
...
```
Write a professional report on the following interview.
...
```json
{
  "product_id": "AA-PRM-HRE-INTERVIEW-SUITE-084",
  "slug": "prompt-interview-guide-suite",
  "name": "Interview Guide Prompt Suite",
  "category": "prompt",
  "subcategory": "prompt_suite",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-interview-guide-suite.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
