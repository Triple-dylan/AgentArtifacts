...
**Product ID:** `AA-DOC-VIB-VIBEGUIDE-108`  
...
Illustrated guide to structuring LLM-driven development workflows with Cursor and Copilot
...
```json
{
  ...
  "title": "Vibe Coding Workflow Guide",
  "description": "Illustrated guide to structuring LLM-driven development workflows with Cursor and Copilot",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Vibe Coding Workflow Guide Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
