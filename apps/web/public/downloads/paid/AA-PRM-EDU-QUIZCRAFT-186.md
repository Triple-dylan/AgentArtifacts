...
**Product ID:** `AA-PRM-EDU-QUIZCRAFT-186`
...
Prompts for auto-generating quizzes, rubrics, and assessment criteria
...
Analyse the following quiz & assessment prompt pack scenario in depth.
