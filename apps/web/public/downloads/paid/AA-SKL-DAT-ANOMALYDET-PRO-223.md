...
**Product ID:** `AA-SKL-DAT-ANOMALYDET-PRO-223`
...
Skill for detecting statistical anomalies and drift in time-series data streams
...
## Configuration
```yaml
skill_id: AA-SKL-DAT-ANOMALYDET-PRO-223
version: 1.0.0
mode: production
...
Extract relevant features for anomaly detection skill processing.
