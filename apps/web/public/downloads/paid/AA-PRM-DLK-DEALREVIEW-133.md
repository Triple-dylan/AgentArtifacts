...
**Product ID:** `AA-PRM-DLK-DEALREVIEW-133`  
...
Quick-fire prompts for structuring deal reviews, exceptions, and approval narratives
...
```
Analyse the following deal review in depth.
...
```
Process the following deal review and return a structured JSON response.
...
```
Compare the following deal review options and recommend the best choice.
...
```
Review the following deal review and identify the top 5 improvements.
...
```
Generate a complete, professional deal review for the following specification.
...
```
Validate the following deal review against best practices and requirements.
...
```
Adapt the following deal review for a different audience or context.
...
```
Summarise the following deal review for an executive audience.
...
```
Review and improve the following deal review draft.
...
```
Generate 15 clarifying questions about the following deal review.
...
```
Prioritise the following deal review items using the given criteria.
...
```
Write a professional report on the following deal review.
...
```json
{
  "product_id": "AA-PRM-DLK-DEALREVIEW-133",
  "slug": "prompt-deal-review-pack",
  "name": "Deal Review Prompt Pack",
  "category": "prompt",
  "subcategory": "prompt_pack",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-deal-review-pack.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
