...
**Product ID:** `AA-SKL-EDU-ADAPTLEARN-PRO-219`
...
Skill that adjusts content difficulty and pacing based on learner performance
...
## Configuration
```yaml
skill_id: AA-SKL-EDU-ADAPTLEARN-PRO-219
version: 1.0.0
mode: production
...
Extract relevant features for adaptive learning skill processing.
