# Tool Router Skill Module
**Product ID:** `AA-SKL-GEN-TOOLROUTER-CORE-013`  
...
Tool call routing skill for agent workflows

This skill module provides a standardised interface for integrating AI-powered
`tool router` capabilities into any agent workflow.
...
```markdown
# Skill: Tool Router Skill Module v1.0
...
```
You are a specialised AI skill module for tool router.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for tool router.
...
Save as `.claude/skills/skill-tool-router.md` and invoke with `/tool-router`
...
```json
{
  "product_id": "AA-SKL-GEN-TOOLROUTER-CORE-013",
  "skill_name": "Tool Router Skill Module",
  "version": "1.0.0",
  "category": "skill",
