# Dynamic Quote Builder Skill
**Product ID:** `AA-SKL-DLK-QUOTEBUILDER-138`  
...
Generates tiered pricing quotes with volume discounts, bundling, and multi-year lock-in logic

This skill module provides a standardised interface for integrating AI-powered
`dynamic quote builder` capabilities into any agent workflow.
...
```markdown
# Skill: Dynamic Quote Builder Skill v1.0
...
```
You are a specialised AI skill module for dynamic quote builder.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for dynamic quote builder.
...
Save as `.claude/skills/skill-quote-builder-module.md` and invoke with `/quote-builder-module`
...
```json
{
  "product_id": "AA-SKL-DLK-QUOTEBUILDER-138",
  "skill_name": "Dynamic Quote Builder Skill",
  "version": "1.0.0",
  "category": "skill",
