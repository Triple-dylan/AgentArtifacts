# PM AI Workflow Playbook
**Product ID:** `AA-DOC-PMG-PMPLAYBOOK-164`  
...
Practical playbook for integrating LLMs into discovery, planning, and delivery workflows

This utility provides schemas, templates, and reference definitions for `doc` use cases.
...
```json
{
  ...
  "title": "PM AI Workflow Playbook",
  "description": "Practical playbook for integrating LLMs into discovery, planning, and delivery workflows",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "PM AI Workflow Playbook Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
