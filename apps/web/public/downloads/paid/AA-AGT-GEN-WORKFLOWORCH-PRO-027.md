...
**Product ID:** `AA-AGT-GEN-WORKFLOWORCH-PRO-027`  
...
General workflow orchestration agent package
...
```json
{
  "agent_id": "AA-AGT-GEN-WORKFLOWORCH-PRO-027",
  "name": "Workflow Orchestrator Agent",
  "version": "1.0.0",
  "description": "General workflow orchestration agent package",
  "category": "agent",
  "execution_mode": "none",
...
```
You are Workflow Orchestrator Agent, a specialised AI agent for workflow orchestrator tasks.

Your capabilities:
- Analyse and process workflow orchestrator-related inputs
...
You have access to the Workflow Orchestrator Agent agent capability.
When asked to perform workflow orchestrator tasks, follow the workflow defined in this package.
```
