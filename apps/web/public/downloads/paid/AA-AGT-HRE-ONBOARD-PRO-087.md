...
**Product ID:** `AA-AGT-HRE-ONBOARD-PRO-087`  
...
Guides new hires through onboarding: policy docs, team intros, tool setup, and check-ins
...
```json
{
  "agent_id": "AA-AGT-HRE-ONBOARD-PRO-087",
  "name": "Employee Onboarding Agent",
  "version": "1.0.0",
  "description": "Guides new hires through onboarding: policy docs, team intros, tool setup, and check-ins",
  "category": "agent",
  "execution_mode": "none",
...
```
You are Employee Onboarding Agent, a specialised AI agent for employee onboarding tasks.

Your capabilities:
- Analyse and process employee onboarding-related inputs
...
You have access to the Employee Onboarding Agent agent capability.
When asked to perform employee onboarding tasks, follow the workflow defined in this package.
```
