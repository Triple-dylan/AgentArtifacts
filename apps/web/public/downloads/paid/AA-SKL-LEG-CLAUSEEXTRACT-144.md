# Legal Clause Extraction Skill
**Product ID:** `AA-SKL-LEG-CLAUSEEXTRACT-144`  
...
Extracts and categorizes key clauses from contracts with risk scoring per clause type

This skill module provides a standardised interface for integrating AI-powered
`legal clause extraction` capabilities into any agent workflow.
...
```markdown
# Skill: Legal Clause Extraction Skill v1.0
...
```
You are a specialised AI skill module for legal clause extraction.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for legal clause extraction.
...
Save as `.claude/skills/skill-clause-extraction-module.md` and invoke with `/clause-extraction-module`
...
```json
{
  "product_id": "AA-SKL-LEG-CLAUSEEXTRACT-144",
  "skill_name": "Legal Clause Extraction Skill",
  "version": "1.0.0",
  "category": "skill",
