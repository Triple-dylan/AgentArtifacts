...
**Product ID:** `AA-PRM-HR-JOBDESC-187`
...
Prompts for crafting inclusive, structured job descriptions with role requirements
...
Analyse the following job description writer prompts scenario in depth.
