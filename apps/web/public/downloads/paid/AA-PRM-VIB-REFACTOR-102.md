...
**Product ID:** `AA-PRM-VIB-REFACTOR-102`  
...
Targeted prompts for AI-driven code refactoring, cleanup, and pattern enforcement
...
```
Analyse the following ai refactor in depth.
...
```
Process the following ai refactor and return a structured JSON response.
...
```
Compare the following ai refactor options and recommend the best choice.
...
```
Review the following ai refactor and identify the top 5 improvements.
...
```
Generate a complete, professional ai refactor for the following specification.
...
```
Validate the following ai refactor against best practices and requirements.
...
```
Adapt the following ai refactor for a different audience or context.
...
```
Summarise the following ai refactor for an executive audience.
...
```
Review and improve the following ai refactor draft.
...
```
Generate 15 clarifying questions about the following ai refactor.
...
```
Prioritise the following ai refactor items using the given criteria.
...
```
Write a professional report on the following ai refactor.
...
```json
{
  "product_id": "AA-PRM-VIB-REFACTOR-102",
  "slug": "prompt-ai-refactor-pack",
  "name": "AI Refactor Prompt Pack",
  "category": "prompt",
  "subcategory": "prompt_pack",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-ai-refactor-pack.md",
    "manifest.json"
  ],
  "compatibility": [
    "cursor ",
