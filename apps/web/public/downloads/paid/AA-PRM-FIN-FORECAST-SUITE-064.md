# Financial Forecast Prompt Suite
**Product ID:** `AA-PRM-FIN-FORECAST-SUITE-064`  
...
Chained prompts for revenue projection, scenario modeling, and variance commentary
...
```
Analyse the following financial forecast in depth.
...
```
Process the following financial forecast and return a structured JSON response.
...
```
Compare the following financial forecast options and recommend the best choice.
...
```
Review the following financial forecast and identify the top 5 improvements.
...
```
Generate a complete, professional financial forecast for the following specification.
...
```
Validate the following financial forecast against best practices and requirements.
...
```
Adapt the following financial forecast for a different audience or context.
...
```
Summarise the following financial forecast for an executive audience.
...
```
Review and improve the following financial forecast draft.
...
```
Generate 15 clarifying questions about the following financial forecast.
...
```
Prioritise the following financial forecast items using the given criteria.
...
```
Write a professional report on the following financial forecast.
...
```json
{
  "product_id": "AA-PRM-FIN-FORECAST-SUITE-064",
  "slug": "prompt-financial-forecast-suite",
  "name": "Financial Forecast Prompt Suite",
  "category": "prompt",
  "subcategory": "prompt_suite",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-financial-forecast-suite.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
