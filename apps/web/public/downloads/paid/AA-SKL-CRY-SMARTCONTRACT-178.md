# Smart Contract Audit Assist Skill
**Product ID:** `AA-SKL-CRY-SMARTCONTRACT-178`  
...
Flags common Solidity vulnerabilities including reentrancy, overflow, and access control issues

This skill module provides a standardised interface for integrating AI-powered
`smart contract audit assist` capabilities into any agent workflow.
...
```markdown
# Skill: Smart Contract Audit Assist Skill v1.0
...
```
You are a specialised AI skill module for smart contract audit assist.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for smart contract audit assist.
...
Save as `.claude/skills/skill-smart-contract-audit-assist.md` and invoke with `/smart-contract-audit-assist`
...
```json
{
  "product_id": "AA-SKL-CRY-SMARTCONTRACT-178",
  "skill_name": "Smart Contract Audit Assist Skill",
  "version": "1.0.0",
  "category": "skill",
