...
**Product ID:** `AA-SKL-CSX-CHURNSCORE-168`  
...
Scores accounts on usage, engagement, and support signals to produce churn risk rankings

This skill module provides a standardised interface for integrating AI-powered
`churn risk scoring` capabilities into any agent workflow.
...
```markdown
# Skill: Churn Risk Scoring Skill v1.0
...
```
You are a specialised AI skill module for churn risk scoring.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for churn risk scoring.
...
Save as `.claude/skills/skill-churn-scoring-module.md` and invoke with `/churn-scoring-module`
...
```json
{
  "product_id": "AA-SKL-CSX-CHURNSCORE-168",
  "skill_name": "Churn Risk Scoring Skill",
  "version": "1.0.0",
  "category": "skill",
