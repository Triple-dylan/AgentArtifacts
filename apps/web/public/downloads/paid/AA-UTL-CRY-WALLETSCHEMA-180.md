# Wallet & Portfolio Schema Utility
**Product ID:** `AA-UTL-CRY-WALLETSCHEMA-180`  
...
Structured schemas for tracking multi-chain wallet positions, token balances, and PnL
...
```json
{
  ...
  "title": "Wallet & Portfolio Schema Utility",
  "description": "Structured schemas for tracking multi-chain wallet positions, token balances, and PnL",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Wallet & Portfolio Schema Utility Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
