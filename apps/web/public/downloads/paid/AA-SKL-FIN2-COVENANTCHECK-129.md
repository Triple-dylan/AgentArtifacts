# Debt Covenant Monitoring Skill
**Product ID:** `AA-SKL-FIN2-COVENANTCHECK-129`  
...
Extracts and monitors financial covenant thresholds against actuals with alert generation

This skill module provides a standardised interface for integrating AI-powered
`debt covenant monitoring` capabilities into any agent workflow.
...
```markdown
# Skill: Debt Covenant Monitoring Skill v1.0
...
```
You are a specialised AI skill module for debt covenant monitoring.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for debt covenant monitoring.
...
Save as `.claude/skills/skill-covenant-check-module.md` and invoke with `/covenant-check-module`
...
```json
{
  "product_id": "AA-SKL-FIN2-COVENANTCHECK-129",
  "skill_name": "Debt Covenant Monitoring Skill",
  "version": "1.0.0",
  "category": "skill",
