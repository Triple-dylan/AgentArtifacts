# Trade Log & Attribution Utility
**Product ID:** `AA-UTL-TRD2-TRADELOG-100`  
...
Structured trade log schema with PnL attribution and export templates for review
...
```json
{
  ...
  "title": "Trade Log & Attribution Utility",
  "description": "Structured trade log schema with PnL attribution and export templates for review",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Trade Log & Attribution Utility Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
