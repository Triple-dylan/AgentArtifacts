# Obligation & Deadline Tracker Skill
**Product ID:** `AA-SKL-LEG-OBLIGATIONTRACK-145`  
...
Surfaces contract obligations, notice periods, and renewal deadlines from uploaded agreements

This skill module provides a standardised interface for integrating AI-powered
`obligation & deadline tracker` capabilities into any agent workflow.
...
```markdown
# Skill: Obligation & Deadline Tracker Skill v1.0
...
```
You are a specialised AI skill module for obligation & deadline tracker.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for obligation & deadline tracker.
...
Save as `.claude/skills/skill-obligation-tracker-module.md` and invoke with `/obligation-tracker-module`
...
```json
{
  "product_id": "AA-SKL-LEG-OBLIGATIONTRACK-145",
  "skill_name": "Obligation & Deadline Tracker Skill",
  "version": "1.0.0",
  "category": "skill",
