# Signal Filter & Dedup Skill
**Product ID:** `AA-SKL-TRD2-SIGNALFILTER-096`  
...
Deduplicate and rank competing trade signals before position sizing

This skill module provides a standardised interface for integrating AI-powered
`signal filter & dedup` capabilities into any agent workflow.
...
```markdown
# Skill: Signal Filter & Dedup Skill v1.0
...
```
You are a specialised AI skill module for signal filter & dedup.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for signal filter & dedup.
...
Save as `.claude/skills/skill-signal-filter-module.md` and invoke with `/signal-filter-module`
...
```json
{
  "product_id": "AA-SKL-TRD2-SIGNALFILTER-096",
  "skill_name": "Signal Filter & Dedup Skill",
  "version": "1.0.0",
  "category": "skill",
