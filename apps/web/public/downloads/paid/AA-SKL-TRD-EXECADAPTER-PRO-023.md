# Execution Adapter Skill
**Product ID:** `AA-SKL-TRD-EXECADAPTER-PRO-023`  
...
Connector skill for paper and live execution

This skill module provides a standardised interface for integrating AI-powered
`execution adapter` capabilities into any agent workflow.
...
```markdown
# Skill: Execution Adapter Skill v1.0
...
```
You are a specialised AI skill module for execution adapter.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for execution adapter.
...
Save as `.claude/skills/skill-trading-execution-adapter.md` and invoke with `/trading-execution-adapter`
...
```json
{
  "product_id": "AA-SKL-TRD-EXECADAPTER-PRO-023",
  "skill_name": "Execution Adapter Skill",
  "version": "1.0.0",
  "category": "skill",
