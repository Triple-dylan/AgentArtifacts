# SERP-Aware Rewrite Skill
**Product ID:** `AA-SKL-SEO-SERPREWRITE-152`  
...
Rewrites existing content to outrank top SERP results using semantic gap analysis

This skill module provides a standardised interface for integrating AI-powered
`serp-aware rewrite` capabilities into any agent workflow.
...
```markdown
# Skill: SERP-Aware Rewrite Skill v1.0
...
```
You are a specialised AI skill module for serp-aware rewrite.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for serp-aware rewrite.
...
Save as `.claude/skills/skill-serp-rewrite-module.md` and invoke with `/serp-rewrite-module`
...
```json
{
  "product_id": "AA-SKL-SEO-SERPREWRITE-152",
  "skill_name": "SERP-Aware Rewrite Skill",
  "version": "1.0.0",
  "category": "skill",
