...
**Product ID:** `AA-SKL-MKT-CONTENTPIPE-PRO-016`  
...
Marketing content workflow skill with scoring

This skill module provides a standardised interface for integrating AI-powered
`content pipeline` capabilities into any agent workflow.
...
```markdown
# Skill: Content Pipeline Skill v1.0
...
```
You are a specialised AI skill module for content pipeline.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for content pipeline.
...
Save as `.claude/skills/skill-marketing-content-pipeline.md` and invoke with `/marketing-content-pipeline`
...
```json
{
  "product_id": "AA-SKL-MKT-CONTENTPIPE-PRO-016",
  "skill_name": "Content Pipeline Skill",
  "version": "1.0.0",
  "category": "skill",
