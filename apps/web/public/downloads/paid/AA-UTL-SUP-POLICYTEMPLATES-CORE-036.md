# Support Policy Template Kit
**Product ID:** `AA-UTL-SUP-POLICYTEMPLATES-CORE-036`  
...
Policy templates for support workflows
...
```json
{
  ...
  "title": "Support Policy Template Kit",
  "description": "Policy templates for support workflows",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Support Policy Template Kit Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
