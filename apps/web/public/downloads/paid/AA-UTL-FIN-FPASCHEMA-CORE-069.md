# FP&A Data Schema Pack
**Product ID:** `AA-UTL-FIN-FPASCHEMA-CORE-069`  
...
JSON schemas for cost centers, budgets, actuals, and forecast periods
...
```json
{
  ...
  "title": "FP&A Data Schema Pack",
  "description": "JSON schemas for cost centers, budgets, actuals, and forecast periods",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "FP&A Data Schema Pack Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
