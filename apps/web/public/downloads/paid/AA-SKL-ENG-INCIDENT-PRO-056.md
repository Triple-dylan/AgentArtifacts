...
**Product ID:** `AA-SKL-ENG-INCIDENT-PRO-056`  
...
Structured skill for triage, impact assessment, and runbook generation during incidents

This skill module provides a standardised interface for integrating AI-powered
`incident response` capabilities into any agent workflow.
...
```markdown
# Skill: Incident Response Skill v1.0
...
```
You are a specialised AI skill module for incident response.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for incident response.
...
Save as `.claude/skills/skill-incident-response-pro.md` and invoke with `/incident-response-pro`
...
```json
{
  "product_id": "AA-SKL-ENG-INCIDENT-PRO-056",
  "skill_name": "Incident Response Skill",
  "version": "1.0.0",
  "category": "skill",
