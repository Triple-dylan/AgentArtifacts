# Deal Scoring & Risk Flag Skill
**Product ID:** `AA-SKL-DLK-DEALSCORING-136`  
...
Scores deal health on margin, discount depth, and close probability with risk flags

This skill module provides a standardised interface for integrating AI-powered
`deal scoring & risk flag` capabilities into any agent workflow.
...
```markdown
# Skill: Deal Scoring & Risk Flag Skill v1.0
...
```
You are a specialised AI skill module for deal scoring & risk flag.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for deal scoring & risk flag.
...
Save as `.claude/skills/skill-deal-scoring-module.md` and invoke with `/deal-scoring-module`
...
```json
{
  "product_id": "AA-SKL-DLK-DEALSCORING-136",
  "skill_name": "Deal Scoring & Risk Flag Skill",
  "version": "1.0.0",
  "category": "skill",
