# Trading Data Normalize Skill
**Product ID:** `AA-SKL-TRD-DATANORMALIZE-PRO-020`  
...
Normalize market and event data feeds

This skill module provides a standardised interface for integrating AI-powered
`trading data normalize` capabilities into any agent workflow.
...
```markdown
# Skill: Trading Data Normalize Skill v1.0
...
```
You are a specialised AI skill module for trading data normalize.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for trading data normalize.
...
Save as `.claude/skills/skill-trading-data-normalize.md` and invoke with `/trading-data-normalize`
...
```json
{
  "product_id": "AA-SKL-TRD-DATANORMALIZE-PRO-020",
  "skill_name": "Trading Data Normalize Skill",
  "version": "1.0.0",
  "category": "skill",
