# Deal Brief Generator Skill
**Product ID:** `AA-SKL-SLS-DEALBRIEF-PRO-046`  
...
Auto-generate deal briefs and account summaries from CRM data

This skill module provides a standardised interface for integrating AI-powered
`deal brief generator` capabilities into any agent workflow.
...
```markdown
# Skill: Deal Brief Generator Skill v1.0
...
```
You are a specialised AI skill module for deal brief generator.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for deal brief generator.
...
Save as `.claude/skills/skill-deal-brief-pro.md` and invoke with `/deal-brief-pro`
...
```json
{
  "product_id": "AA-SKL-SLS-DEALBRIEF-PRO-046",
  "skill_name": "Deal Brief Generator Skill",
  "version": "1.0.0",
  "category": "skill",
