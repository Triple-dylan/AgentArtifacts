# Escalation Flow Skill
**Product ID:** `AA-SKL-SUP-ESCALATIONFLOW-PRO-019`  
...
Escalation logic with guardrails

This skill module provides a standardised interface for integrating AI-powered
`escalation flow` capabilities into any agent workflow.
...
```markdown
# Skill: Escalation Flow Skill v1.0
...
```
You are a specialised AI skill module for escalation flow.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for escalation flow.
...
Save as `.claude/skills/skill-support-escalation-flow.md` and invoke with `/support-escalation-flow`
...
```json
{
  "product_id": "AA-SKL-SUP-ESCALATIONFLOW-PRO-019",
  "skill_name": "Escalation Flow Skill",
  "version": "1.0.0",
  "category": "skill",
