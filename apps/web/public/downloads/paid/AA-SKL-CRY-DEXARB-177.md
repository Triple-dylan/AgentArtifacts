# DEX Arbitrage Scanner Skill
**Product ID:** `AA-SKL-CRY-DEXARB-177`  
...
Scans AMM pools for arbitrage spreads and estimates gas-adjusted profit potential

This skill module provides a standardised interface for integrating AI-powered
`dex arbitrage scanner` capabilities into any agent workflow.
...
```markdown
# Skill: DEX Arbitrage Scanner Skill v1.0
...
```
You are a specialised AI skill module for dex arbitrage scanner.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for dex arbitrage scanner.
...
Save as `.claude/skills/skill-dex-arb-scanner.md` and invoke with `/dex-arb-scanner`
...
```json
{
  "product_id": "AA-SKL-CRY-DEXARB-177",
  "skill_name": "DEX Arbitrage Scanner Skill",
  "version": "1.0.0",
  "category": "skill",
