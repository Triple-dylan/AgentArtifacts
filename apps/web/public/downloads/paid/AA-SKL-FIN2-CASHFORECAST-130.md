...
**Product ID:** `AA-SKL-FIN2-CASHFORECAST-130`  
...
Auto-generates rolling 13-week cash forecasts from AP/AR data with scenario toggles

This skill module provides a standardised interface for integrating AI-powered
`13-week cash flow forecast` capabilities into any agent workflow.
...
```markdown
# Skill: 13-Week Cash Flow Forecast Skill v1.0
...
```
You are a specialised AI skill module for 13-week cash flow forecast.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for 13-week cash flow forecast.
...
Save as `.claude/skills/skill-cash-forecast-module.md` and invoke with `/cash-forecast-module`
...
```json
{
  "product_id": "AA-SKL-FIN2-CASHFORECAST-130",
  "skill_name": "13-Week Cash Flow Forecast Skill",
  "version": "1.0.0",
  "category": "skill",
