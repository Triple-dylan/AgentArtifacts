...
**Product ID:** `AA-PRM-PMG-ROADMAP-190`
...
Prompts for generating quarterly roadmaps with prioritisation frameworks
...
Analyse the following roadmap planning prompt pack scenario in depth.
