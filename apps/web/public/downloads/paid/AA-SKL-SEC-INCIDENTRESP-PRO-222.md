...
**Product ID:** `AA-SKL-SEC-INCIDENTRESP-PRO-222`
...
Skill for coordinating incident response workflows with containment and recovery steps
...
## Configuration
```yaml
skill_id: AA-SKL-SEC-INCIDENTRESP-PRO-222
version: 1.0.0
mode: production
...
Extract relevant features for incident response skill processing.
