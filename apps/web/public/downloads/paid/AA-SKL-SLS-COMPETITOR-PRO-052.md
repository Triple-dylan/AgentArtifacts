...
**Product ID:** `AA-SKL-SLS-COMPETITOR-PRO-052`  
...
Skill for summarizing competitor positioning from web data and call notes

This skill module provides a standardised interface for integrating AI-powered
`competitive intelligence` capabilities into any agent workflow.
...
```markdown
# Skill: Competitive Intelligence Skill v1.0
...
```
You are a specialised AI skill module for competitive intelligence.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for competitive intelligence.
...
Save as `.claude/skills/skill-competitive-intel-pro.md` and invoke with `/competitive-intel-pro`
...
```json
{
  "product_id": "AA-SKL-SLS-COMPETITOR-PRO-052",
  "skill_name": "Competitive Intelligence Skill",
  "version": "1.0.0",
  "category": "skill",
