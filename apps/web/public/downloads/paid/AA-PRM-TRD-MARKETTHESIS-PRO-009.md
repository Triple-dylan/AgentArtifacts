...
**Product ID:** `AA-PRM-TRD-MARKETTHESIS-PRO-009`  
...
Prompts for market hypothesis building
...
```
Analyse the following market thesis in depth.
...
```
Process the following market thesis and return a structured JSON response.
...
```
Compare the following market thesis options and recommend the best choice.
...
```
Review the following market thesis and identify the top 5 improvements.
...
```
Generate a complete, professional market thesis for the following specification.
...
```
Validate the following market thesis against best practices and requirements.
...
```
Adapt the following market thesis for a different audience or context.
...
```
Summarise the following market thesis for an executive audience.
...
```
Review and improve the following market thesis draft.
...
```
Generate 15 clarifying questions about the following market thesis.
...
```
Prioritise the following market thesis items using the given criteria.
...
```
Write a professional report on the following market thesis.
...
```json
{
  ...
  "slug": "prompt-trading-market-thesis",
  "name": "Market Thesis Prompt Pack",
  "category": "prompt",
  "subcategory": "prompt_pack",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-trading-market-thesis.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
