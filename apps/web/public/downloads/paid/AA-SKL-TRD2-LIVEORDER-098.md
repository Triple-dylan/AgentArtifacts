# Live Order Router Skill
**Product ID:** `AA-SKL-TRD2-LIVEORDER-098`  
...
Broker-agnostic order routing skill for live execution with pre-trade risk gates

This skill module provides a standardised interface for integrating AI-powered
`live order router` capabilities into any agent workflow.
...
```markdown
# Skill: Live Order Router Skill v1.0
...
```
You are a specialised AI skill module for live order router.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for live order router.
...
Save as `.claude/skills/skill-live-order-router.md` and invoke with `/live-order-router`
...
```json
{
  "product_id": "AA-SKL-TRD2-LIVEORDER-098",
  "skill_name": "Live Order Router Skill",
  "version": "1.0.0",
  "category": "skill",
