# Data Cleaning Skill
**Product ID:** `AA-SKL-DAT-DATACLEAN-PRO-076`  
...
Skill for profiling, validating, and cleaning structured datasets with output schemas

This skill module provides a standardised interface for integrating AI-powered
`data cleaning` capabilities into any agent workflow.
...
```markdown
# Skill: Data Cleaning Skill v1.0
...
```
You are a specialised AI skill module for data cleaning.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for data cleaning.
...
Save as `.claude/skills/skill-data-cleaning-pro.md` and invoke with `/data-cleaning-pro`
...
```json
{
  "product_id": "AA-SKL-DAT-DATACLEAN-PRO-076",
  "skill_name": "Data Cleaning Skill",
  "version": "1.0.0",
  "category": "skill",
