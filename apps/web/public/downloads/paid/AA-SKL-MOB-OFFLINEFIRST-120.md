...
**Product ID:** `AA-SKL-MOB-OFFLINEFIRST-120`  
...
Generates conflict-resolution and sync logic for offline-first React Native and Flutter apps

This skill module provides a standardised interface for integrating AI-powered
`offline-first sync` capabilities into any agent workflow.
...
```markdown
# Skill: Offline-First Sync Skill v1.0
...
```
You are a specialised AI skill module for offline-first sync.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for offline-first sync.
...
Save as `.claude/skills/skill-offline-first-sync.md` and invoke with `/offline-first-sync`
...
```json
{
  "product_id": "AA-SKL-MOB-OFFLINEFIRST-120",
  "skill_name": "Offline-First Sync Skill",
  "version": "1.0.0",
  "category": "skill",
