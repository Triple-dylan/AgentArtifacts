# Sprint Planning & Story Splitter Skill
**Product ID:** `AA-SKL-PMG-SPRINTPLAN-162`  
...
Splits epics into right-sized stories, estimates complexity, and drafts sprint ceremonies

This skill module provides a standardised interface for integrating AI-powered
`sprint planning & story splitter` capabilities into any agent workflow.
...
```markdown
# Skill: Sprint Planning & Story Splitter Skill v1.0
...
```
You are a specialised AI skill module for sprint planning & story splitter.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for sprint planning & story splitter.
...
Save as `.claude/skills/skill-sprint-planning-module.md` and invoke with `/sprint-planning-module`
...
```json
{
  "product_id": "AA-SKL-PMG-SPRINTPLAN-162",
  "skill_name": "Sprint Planning & Story Splitter Skill",
  "version": "1.0.0",
  "category": "skill",
