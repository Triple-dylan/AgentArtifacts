# Content Audit & Prune Skill
**Product ID:** `AA-SKL-SEO-CONTENTAUDIT-154`  
...
Audits site content for thin pages, cannibalization, and decay; outputs a prioritized prune plan

This skill module provides a standardised interface for integrating AI-powered
`content audit & prune` capabilities into any agent workflow.
...
```markdown
# Skill: Content Audit & Prune Skill v1.0
...
```
You are a specialised AI skill module for content audit & prune.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for content audit & prune.
...
Save as `.claude/skills/skill-content-audit-module.md` and invoke with `/content-audit-module`
...
```json
{
  "product_id": "AA-SKL-SEO-CONTENTAUDIT-154",
  "skill_name": "Content Audit & Prune Skill",
  "version": "1.0.0",
  "category": "skill",
