# AI Redline Generator Skill
**Product ID:** `AA-SKL-LEG-REDLINEGEN-146`  
...
Generates tracked-changes redlines on commercial contracts against your standard playbook

This skill module provides a standardised interface for integrating AI-powered
`ai redline generator` capabilities into any agent workflow.
...
```markdown
# Skill: AI Redline Generator Skill v1.0
...
```
You are a specialised AI skill module for ai redline generator.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for ai redline generator.
...
Save as `.claude/skills/skill-redline-generator-module.md` and invoke with `/redline-generator-module`
...
```json
{
  "product_id": "AA-SKL-LEG-REDLINEGEN-146",
  "skill_name": "AI Redline Generator Skill",
  "version": "1.0.0",
  "category": "skill",
