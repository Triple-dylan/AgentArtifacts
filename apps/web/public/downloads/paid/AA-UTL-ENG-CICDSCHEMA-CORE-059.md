# CI/CD Pipeline Schema Pack
**Product ID:** `AA-UTL-ENG-CICDSCHEMA-CORE-059`  
...
JSON schemas for pipeline stages, build configs, and deployment manifests
...
```json
{
  ...
  "title": "CI/CD Pipeline Schema Pack",
  "description": "JSON schemas for pipeline stages, build configs, and deployment manifests",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "CI/CD Pipeline Schema Pack Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
