...
**Product ID:** `AA-PRM-ENG-CODEREV-BASE-053`  
...
Prompt templates for structured code review, PR feedback, and style checks
...
```
Analyse the following code review in depth.
...
```
Process the following code review and return a structured JSON response.
...
```
Compare the following code review options and recommend the best choice.
...
```
Review the following code review and identify the top 5 improvements.
...
```
Generate a complete, professional code review for the following specification.
...
```
Validate the following code review against best practices and requirements.
...
```
Adapt the following code review for a different audience or context.
...
```
Summarise the following code review for an executive audience.
...
```
Review and improve the following code review draft.
...
```
Generate 15 clarifying questions about the following code review.
...
```
Prioritise the following code review items using the given criteria.
...
```
Write a professional report on the following code review.
...
```json
{
  "product_id": "AA-PRM-ENG-CODEREV-BASE-053",
  "slug": "prompt-code-review-base",
  "name": "Code Review Prompt Pack",
  "category": "prompt",
  "subcategory": "prompt_pack",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-code-review-base.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
