# Customer Success Data Schema Utility
**Product ID:** `AA-UTL-CSX-CSSCHEMA-172`  
...
Canonical schemas for account health, onboarding milestones, and renewal data pipelines
...
```json
{
  ...
  "title": "Customer Success Data Schema Utility",
  "description": "Canonical schemas for account health, onboarding milestones, and renewal data pipelines",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Customer Success Data Schema Utility Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
