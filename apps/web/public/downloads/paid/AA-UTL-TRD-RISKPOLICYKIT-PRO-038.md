# Trading Risk Policy Kit
**Product ID:** `AA-UTL-TRD-RISKPOLICYKIT-PRO-038`  
...
Risk policy templates for paper and live execution

This utility provides schemas, templates, and reference definitions for `guardrails yaml` use cases.
...
```json
{
  ...
  "title": "Trading Risk Policy Kit",
  "description": "Risk policy templates for paper and live execution",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Trading Risk Policy Kit Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
