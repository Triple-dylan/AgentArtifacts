# AI Tutor Agent
**Product ID:** `AA-AGT-EDU-TUTORBOT-PRO-224`
...
Agent for personalised tutoring sessions with Socratic questioning and progress tracking
...
## Configuration
```yaml
agent_id: AA-AGT-EDU-TUTORBOT-PRO-224
version: 1.0.0
type: agent_config
