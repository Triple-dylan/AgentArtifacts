# Sales Outreach Prompt Pack
**Product ID:** `AA-PRM-SLS-OUTREACH-BASE-043`  
...
Cold outreach and follow-up prompt templates for SDRs and AEs
...
```
Analyse the following sales outreach in depth.
...
```
Process the following sales outreach and return a structured JSON response.
...
```
Compare the following sales outreach options and recommend the best choice.
...
```
Review the following sales outreach and identify the top 5 improvements.
...
```
Generate a complete, professional sales outreach for the following specification.
...
```
Validate the following sales outreach against best practices and requirements.
...
```
Adapt the following sales outreach for a different audience or context.
...
```
Summarise the following sales outreach for an executive audience.
...
```
Review and improve the following sales outreach draft.
...
```
Generate 15 clarifying questions about the following sales outreach.
...
```
Prioritise the following sales outreach items using the given criteria.
...
```
Write a professional report on the following sales outreach.
...
```json
{
  "product_id": "AA-PRM-SLS-OUTREACH-BASE-043",
  "slug": "prompt-sales-outreach-base",
  "name": "Sales Outreach Prompt Pack",
  "category": "prompt",
  "subcategory": "prompt_pack",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-sales-outreach-base.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
