...
**Product ID:** `AA-SKL-FIN-RECONCILE-PRO-065`  
...
Skill for matching transactions, identifying discrepancies, and generating reconciliation reports

This skill module provides a standardised interface for integrating AI-powered
`account reconciliation` capabilities into any agent workflow.
...
```markdown
# Skill: Account Reconciliation Skill v1.0
...
```
You are a specialised AI skill module for account reconciliation.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for account reconciliation.
...
Save as `.claude/skills/skill-reconciliation-pro.md` and invoke with `/reconciliation-pro`
...
```json
{
  "product_id": "AA-SKL-FIN-RECONCILE-PRO-065",
  "skill_name": "Account Reconciliation Skill",
  "version": "1.0.0",
  "category": "skill",
