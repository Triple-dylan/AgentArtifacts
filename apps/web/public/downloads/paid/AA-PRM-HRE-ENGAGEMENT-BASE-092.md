# Employee Engagement Prompt Pack
**Product ID:** `AA-PRM-HRE-ENGAGEMENT-BASE-092`  
...
Prompts for pulse surveys, recognition messages, and team communication templates
...
```
Analyse the following employee engagement in depth.
...
```
Process the following employee engagement and return a structured JSON response.
...
```
Compare the following employee engagement options and recommend the best choice.
...
```
Review the following employee engagement and identify the top 5 improvements.
...
```
Generate a complete, professional employee engagement for the following specification.
...
```
Validate the following employee engagement against best practices and requirements.
...
```
Adapt the following employee engagement for a different audience or context.
...
```
Summarise the following employee engagement for an executive audience.
...
```
Review and improve the following employee engagement draft.
...
```
Generate 15 clarifying questions about the following employee engagement.
...
```
Prioritise the following employee engagement items using the given criteria.
...
```
Write a professional report on the following employee engagement.
...
```json
{
  "product_id": "AA-PRM-HRE-ENGAGEMENT-BASE-092",
  "slug": "prompt-employee-engagement-base",
  "name": "Employee Engagement Prompt Pack",
  "category": "prompt",
  "subcategory": "prompt_pack",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-employee-engagement-base.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
