# Momentum Strategy Prompt Suite
**Product ID:** `AA-PRM-TRD2-MOMENTUM-SUITE-095`  
...
Comprehensive prompt suite for building and stress-testing momentum trading strategies
...
```
Analyse the following momentum strategy in depth.
...
```
Process the following momentum strategy and return a structured JSON response.
...
```
Compare the following momentum strategy options and recommend the best choice.
...
```
Review the following momentum strategy and identify the top 5 improvements.
...
```
Generate a complete, professional momentum strategy for the following specification.
...
```
Validate the following momentum strategy against best practices and requirements.
...
```
Adapt the following momentum strategy for a different audience or context.
...
```
Summarise the following momentum strategy for an executive audience.
...
```
Review and improve the following momentum strategy draft.
...
```
Generate 15 clarifying questions about the following momentum strategy.
...
```
Prioritise the following momentum strategy items using the given criteria.
...
```
Write a professional report on the following momentum strategy.
...
```json
{
  "product_id": "AA-PRM-TRD2-MOMENTUM-SUITE-095",
  "slug": "prompt-momentum-strategy-suite",
  "name": "Momentum Strategy Prompt Suite",
  "category": "prompt",
  "subcategory": "prompt_suite",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-momentum-strategy-suite.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
