...
**Product ID:** `AA-AGT-DLK-DEALDESK-139`  
...
Agent that reviews deals, checks approval policies, generates quotes, and drafts approval emails
...
```json
{
  "agent_id": "AA-AGT-DLK-DEALDESK-139",
  "name": "Deal Desk Automation Agent",
  "version": "1.0.0",
  "description": "Agent that reviews deals, checks approval policies, generates quotes, and drafts approval emails",
  "category": "agent",
  "execution_mode": "none",
...
```
You are Deal Desk Automation Agent, a specialised AI agent for deal desk automation tasks.

Your capabilities:
- Analyse and process deal desk automation-related inputs
...
```
AGENT: Deal Desk Automation Agent
...
You have access to the Deal Desk Automation Agent agent capability.
When asked to perform deal desk automation tasks, follow the workflow defined in this package.
```
