# Code Planner Decomposition Skill
**Product ID:** `AA-SKL-VIB-CODEPLAN-104`  
...
Breaks natural language feature requests into ordered implementation tasks with test stubs

This skill module provides a standardised interface for integrating AI-powered
`code planner decomposition` capabilities into any agent workflow.
...
```markdown
# Skill: Code Planner Decomposition Skill v1.0
...
```
You are a specialised AI skill module for code planner decomposition.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for code planner decomposition.
...
Save as `.claude/skills/skill-code-planner-module.md` and invoke with `/code-planner-module`
...
```json
{
  "product_id": "AA-SKL-VIB-CODEPLAN-104",
  "skill_name": "Code Planner Decomposition Skill",
  "version": "1.0.0",
  "category": "skill",
