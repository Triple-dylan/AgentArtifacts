# Dynamic Position Sizing Skill
**Product ID:** `AA-SKL-TRD2-POSITIONSIZE-097`  
...
Kelly Criterion and volatility-adjusted position sizing for automated strategies

This skill module provides a standardised interface for integrating AI-powered
`dynamic position sizing` capabilities into any agent workflow.
...
```markdown
# Skill: Dynamic Position Sizing Skill v1.0
...
```
You are a specialised AI skill module for dynamic position sizing.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for dynamic position sizing.
...
Save as `.claude/skills/skill-position-sizing-module.md` and invoke with `/position-sizing-module`
...
```json
{
  "product_id": "AA-SKL-TRD2-POSITIONSIZE-097",
  "skill_name": "Dynamic Position Sizing Skill",
  "version": "1.0.0",
  "category": "skill",
