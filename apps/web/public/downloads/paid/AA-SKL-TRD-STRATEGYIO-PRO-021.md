# Strategy IO Skill
**Product ID:** `AA-SKL-TRD-STRATEGYIO-PRO-021`  
...
Structured strategy input and output schemas

This skill module provides a standardised interface for integrating AI-powered
`strategy io` capabilities into any agent workflow.
...
```
You are a specialised AI skill module for strategy io.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for strategy io.
...
Save as `.claude/skills/skill-trading-strategy-io.md` and invoke with `/trading-strategy-io`
...
```json
{
  "product_id": "AA-SKL-TRD-STRATEGYIO-PRO-021",
  "skill_name": "Strategy IO Skill",
  "version": "1.0.0",
  "category": "skill",
