...
**Product ID:** `AA-SKL-FIN-CASHFLOW-PRO-072`  
...
Structured skill for cash flow projection, liquidity analysis, and alert generation

This skill module provides a standardised interface for integrating AI-powered
`cash flow analysis` capabilities into any agent workflow.
...
```markdown
# Skill: Cash Flow Analysis Skill v1.0
...
```
You are a specialised AI skill module for cash flow analysis.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for cash flow analysis.
...
Save as `.claude/skills/skill-cashflow-analysis-pro.md` and invoke with `/cashflow-analysis-pro`
...
```json
{
  "product_id": "AA-SKL-FIN-CASHFLOW-PRO-072",
  "skill_name": "Cash Flow Analysis Skill",
  "version": "1.0.0",
  "category": "skill",
