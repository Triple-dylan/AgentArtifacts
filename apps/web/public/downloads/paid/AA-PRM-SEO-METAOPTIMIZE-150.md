# Meta Tag Optimization Prompt Pack
**Product ID:** `AA-PRM-SEO-METAOPTIMIZE-150`  
...
Prompts for crafting click-worthy title tags and meta descriptions at scale with A/B variants
...
```
Analyse the following meta tag optimization in depth.
...
```
Process the following meta tag optimization and return a structured JSON response.
...
```
Compare the following meta tag optimization options and recommend the best choice.
...
```
Review the following meta tag optimization and identify the top 5 improvements.
...
```
Generate a complete, professional meta tag optimization for the following specification.
...
```
Validate the following meta tag optimization against best practices and requirements.
...
```
Adapt the following meta tag optimization for a different audience or context.
...
```
Summarise the following meta tag optimization for an executive audience.
...
```
Review and improve the following meta tag optimization draft.
...
```
Generate 15 clarifying questions about the following meta tag optimization.
...
```
Prioritise the following meta tag optimization items using the given criteria.
...
```
Write a professional report on the following meta tag optimization.
...
```json
{
  "product_id": "AA-PRM-SEO-METAOPTIMIZE-150",
  "slug": "prompt-meta-optimization-pack",
  "name": "Meta Tag Optimization Prompt Pack",
  "category": "prompt",
  "subcategory": "prompt_pack",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-meta-optimization-pack.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
