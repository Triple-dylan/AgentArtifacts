...
**Product ID:** `AA-UTL-DAT-KPILIB-CORE-080`  
...
Structured KPI definitions with formulas, benchmarks, and data source mappings

This utility provides schemas, templates, and reference definitions for `memory templates` use cases.
...
```json
{
  ...
  "title": "KPI Definition Library",
  "description": "Structured KPI definitions with formulas, benchmarks, and data source mappings",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "KPI Definition Library Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
