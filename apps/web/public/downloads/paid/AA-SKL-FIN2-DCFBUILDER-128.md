...
**Product ID:** `AA-SKL-FIN2-DCFBUILDER-128`  
...
Builds structured DCF models from company data with sensitivity tables and WACC automation

This skill module provides a standardised interface for integrating AI-powered
`dcf model builder` capabilities into any agent workflow.
...
```markdown
# Skill: DCF Model Builder Skill v1.0
...
```
You are a specialised AI skill module for dcf model builder.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for dcf model builder.
...
Save as `.claude/skills/skill-dcf-model-builder.md` and invoke with `/dcf-model-builder`
...
```json
{
  "product_id": "AA-SKL-FIN2-DCFBUILDER-128",
  "skill_name": "DCF Model Builder Skill",
  "version": "1.0.0",
  "category": "skill",
