...
**Product ID:** `AA-PRM-LEGAL-CONTRACTREV-195`
...
Prompts for clause extraction, risk flagging, and obligation tracking in contracts

This pack covers: `prompt_pack` workflows.
...
Analyse the following contract review starter prompts scenario in depth.
