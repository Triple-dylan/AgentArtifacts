# Account Escalation Handler Skill
**Product ID:** `AA-SKL-CSX-ESCALATION-170`  
...
Detects escalation signals and auto-generates tiered response plans with stakeholder routing

This skill module provides a standardised interface for integrating AI-powered
`account escalation handler` capabilities into any agent workflow.
...
```markdown
# Skill: Account Escalation Handler Skill v1.0
...
```
You are a specialised AI skill module for account escalation handler.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for account escalation handler.
...
Save as `.claude/skills/skill-escalation-handler-module.md` and invoke with `/escalation-handler-module`
...
```json
{
  "product_id": "AA-SKL-CSX-ESCALATION-170",
  "skill_name": "Account Escalation Handler Skill",
  "version": "1.0.0",
  "category": "skill",
