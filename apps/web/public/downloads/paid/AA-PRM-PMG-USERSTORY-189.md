# User Story Writer Prompt Pack
**Product ID:** `AA-PRM-PMG-USERSTORY-189`
...
Prompts for writing user stories with acceptance criteria and edge cases
...
Analyse the following user story writer prompt pack scenario in depth.
