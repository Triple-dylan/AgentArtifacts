# Talent Matching Skill
**Product ID:** `AA-SKL-HR-TALENTMATCH-PRO-220`
...
Skill for scoring candidate-role fit using weighted attribute matching
...
## Configuration
```yaml
skill_id: AA-SKL-HR-TALENTMATCH-PRO-220
version: 1.0.0
mode: production
...
Extract relevant features for talent matching skill processing.
