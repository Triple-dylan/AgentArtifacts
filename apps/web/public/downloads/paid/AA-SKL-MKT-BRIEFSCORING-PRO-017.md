# Brief Scoring Skill
**Product ID:** `AA-SKL-MKT-BRIEFSCORING-PRO-017`  
...
`brief scoring` capabilities into any agent workflow.
...
```
You are a specialised AI skill module for brief scoring.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for brief scoring.
...
Save as `.claude/skills/skill-marketing-brief-scoring.md` and invoke with `/marketing-brief-scoring`
...
```json
{
  "product_id": "AA-SKL-MKT-BRIEFSCORING-PRO-017",
  "skill_name": "Brief Scoring Skill",
  "version": "1.0.0",
  "category": "skill",
