# On-Chain Data Fetcher Skill
**Product ID:** `AA-SKL-CRY-ONCHAIN-176`  
...
Fetches and normalizes on-chain metrics from Ethereum and L2s for agent consumption

This skill module provides a standardised interface for integrating AI-powered
`on-chain data fetcher` capabilities into any agent workflow.
...
```markdown
# Skill: On-Chain Data Fetcher Skill v1.0
...
```
You are a specialised AI skill module for on-chain data fetcher.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for on-chain data fetcher.
...
Save as `.claude/skills/skill-on-chain-data-module.md` and invoke with `/on-chain-data-module`
...
```json
{
  "product_id": "AA-SKL-CRY-ONCHAIN-176",
  "skill_name": "On-Chain Data Fetcher Skill",
  "version": "1.0.0",
  "category": "skill",
