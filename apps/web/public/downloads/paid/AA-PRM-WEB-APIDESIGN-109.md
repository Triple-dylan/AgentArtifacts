# REST API Design Prompt Pack
**Product ID:** `AA-PRM-WEB-APIDESIGN-109`  
...
Proven prompts for endpoint design, versioning strategy, and OpenAPI spec generation
...
```
Analyse the following rest api design in depth.
...
```
Process the following rest api design and return a structured JSON response.
...
```
Compare the following rest api design options and recommend the best choice.
...
```
Review the following rest api design and identify the top 5 improvements.
...
```
Generate a complete, professional rest api design for the following specification.
...
```
Validate the following rest api design against best practices and requirements.
...
```
Adapt the following rest api design for a different audience or context.
...
```
Summarise the following rest api design for an executive audience.
...
```
Review and improve the following rest api design draft.
...
```
Generate 15 clarifying questions about the following rest api design.
...
```
Prioritise the following rest api design items using the given criteria.
...
```
Write a professional report on the following rest api design.
...
```json
{
  "product_id": "AA-PRM-WEB-APIDESIGN-109",
  "slug": "prompt-api-design-pack",
  "name": "REST API Design Prompt Pack",
  "category": "prompt",
  "subcategory": "prompt_pack",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-api-design-pack.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
