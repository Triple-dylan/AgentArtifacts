# AI Pull Request Review Skill
**Product ID:** `AA-SKL-VIB-PRREVIEW-105`  
...
Automated PR review skill covering logic errors, security smells, and code style

This skill module provides a standardised interface for integrating AI-powered
`ai pull request review` capabilities into any agent workflow.
...
```markdown
# Skill: AI Pull Request Review Skill v1.0
...
```
You are a specialised AI skill module for ai pull request review.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for ai pull request review.
...
Save as `.claude/skills/skill-pr-review-module.md` and invoke with `/pr-review-module`
...
```json
{
  "product_id": "AA-SKL-VIB-PRREVIEW-105",
  "skill_name": "AI Pull Request Review Skill",
  "version": "1.0.0",
  "category": "skill",
