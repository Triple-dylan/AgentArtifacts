# Financial Model Assumptions Prompt Pack
**Product ID:** `AA-PRM-FIN2-MODELASSUMP-125`  
...
Structured prompts for documenting and stress-testing financial model assumptions
...
```
Analyse the following financial model assumptions in depth.
...
```
Process the following financial model assumptions and return a structured JSON response.
...
```
Compare the following financial model assumptions options and recommend the best choice.
...
```
Review the following financial model assumptions and identify the top 5 improvements.
...
```
Generate a complete, professional financial model assumptions for the following specification.
...
```
Validate the following financial model assumptions against best practices and requirements.
...
```
Adapt the following financial model assumptions for a different audience or context.
...
```
Summarise the following financial model assumptions for an executive audience.
...
```
Review and improve the following financial model assumptions draft.
...
```
Generate 15 clarifying questions about the following financial model assumptions.
...
```
Prioritise the following financial model assumptions items using the given criteria.
...
```
Write a professional report on the following financial model assumptions.
...
```json
{
  "product_id": "AA-PRM-FIN2-MODELASSUMP-125",
  "slug": "prompt-financial-model-assumptions-pack",
  "name": "Financial Model Assumptions Prompt Pack",
  "category": "prompt",
  "subcategory": "prompt_pack",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-financial-model-assumptions-pack.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
