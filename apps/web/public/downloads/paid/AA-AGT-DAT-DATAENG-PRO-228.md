...
**Product ID:** `AA-AGT-DAT-DATAENG-PRO-228`
...
Agent for designing schemas, writing transformations, and validating data pipelines
...
## Configuration
```yaml
agent_id: AA-AGT-DAT-DATAENG-PRO-228
version: 1.0.0
type: agent_config
