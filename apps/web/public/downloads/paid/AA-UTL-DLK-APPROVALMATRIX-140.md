# Deal Approval Matrix Utility
**Product ID:** `AA-UTL-DLK-APPROVALMATRIX-140`  
...
Configurable approval matrix templates with threshold rules for discount and contract exceptions

This utility provides schemas, templates, and reference definitions for `utility module` use cases.
...
```json
{
  ...
  "title": "Deal Approval Matrix Utility",
  "description": "Configurable approval matrix templates with threshold rules for discount and contract exceptions",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Deal Approval Matrix Utility Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
