# Marketing OpenAPI Wrapper Pack
**Product ID:** `AA-UTL-MKT-OPENAPIWRAPPER-CORE-035`  
...
OpenAPI wrapper templates for marketing APIs

This utility provides schemas, templates, and reference definitions for `openapi wrapper` use cases.
...
```json
{
  ...
  "title": "Marketing OpenAPI Wrapper Pack",
  "description": "OpenAPI wrapper templates for marketing APIs",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Marketing OpenAPI Wrapper Pack Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
