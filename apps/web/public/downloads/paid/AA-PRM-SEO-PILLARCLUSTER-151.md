# Pillar & Cluster Content Prompt Suite
**Product ID:** `AA-PRM-SEO-PILLARCLUSTER-151`  
...
Map, outline, and draft entire pillar-cluster content architectures with internal link strategy
...
```
Analyse the following pillar & cluster content in depth.
...
```
Process the following pillar & cluster content and return a structured JSON response.
...
```
Compare the following pillar & cluster content options and recommend the best choice.
...
```
Review the following pillar & cluster content and identify the top 5 improvements.
...
```
Generate a complete, professional pillar & cluster content for the following specification.
...
```
Validate the following pillar & cluster content against best practices and requirements.
...
```
Adapt the following pillar & cluster content for a different audience or context.
...
```
Summarise the following pillar & cluster content for an executive audience.
...
```
Review and improve the following pillar & cluster content draft.
...
```
Generate 15 clarifying questions about the following pillar & cluster content.
...
```
Prioritise the following pillar & cluster content items using the given criteria.
...
```
Write a professional report on the following pillar & cluster content.
...
```json
{
  "product_id": "AA-PRM-SEO-PILLARCLUSTER-151",
  "slug": "prompt-pillar-cluster-suite",
  "name": "Pillar & Cluster Content Prompt Suite",
  "category": "prompt",
  "subcategory": "prompt_suite",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-pillar-cluster-suite.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
