# Product Metrics Definition Skill
**Product ID:** `AA-SKL-PMG-METRICSDEFINE-161`  
...
Defines north star metrics, guardrail metrics, and measurement plans for product initiatives

This skill module provides a standardised interface for integrating AI-powered
`product metrics definition` capabilities into any agent workflow.
...
```markdown
# Skill: Product Metrics Definition Skill v1.0
...
```
You are a specialised AI skill module for product metrics definition.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for product metrics definition.
...
Save as `.claude/skills/skill-product-metrics-module.md` and invoke with `/product-metrics-module`
...
```json
{
  "product_id": "AA-SKL-PMG-METRICSDEFINE-161",
  "skill_name": "Product Metrics Definition Skill",
  "version": "1.0.0",
  "category": "skill",
