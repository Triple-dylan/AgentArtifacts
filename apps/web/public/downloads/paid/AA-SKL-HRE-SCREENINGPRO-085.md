...
**Product ID:** `AA-SKL-HRE-SCREENINGPRO-085`  
...
Structured skill for CV parsing, requirement matching, and shortlist generation

This skill module provides a standardised interface for integrating AI-powered
`candidate screening` capabilities into any agent workflow.
...
```markdown
# Skill: Candidate Screening Skill v1.0
...
```
You are a specialised AI skill module for candidate screening.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for candidate screening.
...
Save as `.claude/skills/skill-candidate-screening-pro.md` and invoke with `/candidate-screening-pro`
...
```json
{
  "product_id": "AA-SKL-HRE-SCREENINGPRO-085",
  "skill_name": "Candidate Screening Skill",
  "version": "1.0.0",
  "category": "skill",
