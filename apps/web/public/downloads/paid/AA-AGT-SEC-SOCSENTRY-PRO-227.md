# SOC Sentry Agent
**Product ID:** `AA-AGT-SEC-SOCSENTRY-PRO-227`
...
Agent for monitoring security alerts, enriching IOCs, and drafting incident reports
...
## Configuration
```yaml
agent_id: AA-AGT-SEC-SOCSENTRY-PRO-227
version: 1.0.0
type: agent_config
