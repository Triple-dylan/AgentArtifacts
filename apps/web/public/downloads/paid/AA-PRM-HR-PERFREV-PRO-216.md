# Performance Review Prompt Suite
**Product ID:** `AA-PRM-HR-PERFREV-PRO-216`
...
Prompt suite for 360 reviews, self-assessments, and calibration narratives
...
Analyse the following performance review prompt suite scenario in depth.
