# User Research Synthesis Prompt Pack
**Product ID:** `AA-PRM-PMG-USERRESEARCH-158`  
...
Prompts for synthesizing user interviews, surveys, and session data into actionable insights
...
```
Analyse the following user research synthesis in depth.
...
```
Process the following user research synthesis and return a structured JSON response.
...
```
Compare the following user research synthesis options and recommend the best choice.
...
```
Review the following user research synthesis and identify the top 5 improvements.
...
```
Generate a complete, professional user research synthesis for the following specification.
...
```
Validate the following user research synthesis against best practices and requirements.
...
```
Adapt the following user research synthesis for a different audience or context.
...
```
Summarise the following user research synthesis for an executive audience.
...
```
Review and improve the following user research synthesis draft.
...
```
Generate 15 clarifying questions about the following user research synthesis.
...
```
Prioritise the following user research synthesis items using the given criteria.
...
```
Write a professional report on the following user research synthesis.
...
```json
{
  "product_id": "AA-PRM-PMG-USERRESEARCH-158",
  "slug": "prompt-user-research-pack",
  "name": "User Research Synthesis Prompt Pack",
  "category": "prompt",
  "subcategory": "prompt_pack",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-user-research-pack.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
