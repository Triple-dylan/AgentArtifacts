# DeFi Protocol Analysis Prompt Pack
**Product ID:** `AA-PRM-CRY-DEFIANALYSIS-173`  
...
Prompts for analyzing DeFi protocol tokenomics, liquidity depth, and smart contract risk
...
```
Analyse the following defi protocol analysis in depth.
...
```
Process the following defi protocol analysis and return a structured JSON response.
...
```
Compare the following defi protocol analysis options and recommend the best choice.
...
```
Review the following defi protocol analysis and identify the top 5 improvements.
...
```
Generate a complete, professional defi protocol analysis for the following specification.
...
```
Validate the following defi protocol analysis against best practices and requirements.
...
```
Adapt the following defi protocol analysis for a different audience or context.
...
```
Summarise the following defi protocol analysis for an executive audience.
...
```
Review and improve the following defi protocol analysis draft.
...
```
Generate 15 clarifying questions about the following defi protocol analysis.
...
```
Prioritise the following defi protocol analysis items using the given criteria.
...
```
Write a professional report on the following defi protocol analysis.
...
```json
{
  "product_id": "AA-PRM-CRY-DEFIANALYSIS-173",
  "slug": "prompt-defi-analysis-pack",
  "name": "DeFi Protocol Analysis Prompt Pack",
  "category": "prompt",
  "subcategory": "prompt_pack",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-defi-analysis-pack.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
