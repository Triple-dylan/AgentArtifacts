...
**Product ID:** `AA-DOC-MOB-RELEASEGUIDE-124`  
...
Step-by-step release playbook for iOS and Android covering testing, review, and rollout strategy
...
```json
{
  ...
  "title": "Mobile Release Playbook",
  "description": "Step-by-step release playbook for iOS and Android covering testing, review, and rollout strategy",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Mobile Release Playbook Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
