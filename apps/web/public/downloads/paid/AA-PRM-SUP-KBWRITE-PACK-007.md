# Knowledge Base Writing Prompts
**Product ID:** `AA-PRM-SUP-KBWRITE-PACK-007`  
...
Prompts for support article drafting
...
```
Analyse the following knowledge base writing prompts in depth.
...
```
Process the following knowledge base writing prompts and return a structured JSON response.
...
```
Compare the following knowledge base writing prompts options and recommend the best choice.
...
```
Review the following knowledge base writing prompts and identify the top 5 improvements.
...
```
Generate a complete, professional knowledge base writing prompts for the following specification.
...
```
Validate the following knowledge base writing prompts against best practices and requirements.
...
```
Adapt the following knowledge base writing prompts for a different audience or context.
...
```
Summarise the following knowledge base writing prompts for an executive audience.
...
```
Review and improve the following knowledge base writing prompts draft.
...
```
Generate 15 clarifying questions about the following knowledge base writing prompts.
...
```
Prioritise the following knowledge base writing prompts items using the given criteria.
...
```
Write a professional report on the following knowledge base writing prompts.
...
```json
{
  "product_id": "AA-PRM-SUP-KBWRITE-PACK-007",
  "slug": "prompt-kb-write-pack",
  "name": "Knowledge Base Writing Prompts",
  "category": "prompt",
  "subcategory": "prompt_pack",
  "version": "1.0.0",
  "license": "commercial-single-seat",
  "files": [
    "prompt-kb-write-pack.md",
    "manifest.json"
  ],
  "compatibility": [
    "openai ",
