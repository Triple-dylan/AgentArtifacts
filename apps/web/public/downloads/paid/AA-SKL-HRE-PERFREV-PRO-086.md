...
**Product ID:** `AA-SKL-HRE-PERFREV-PRO-086`  
...
Skill for drafting structured performance reviews from manager notes and goal data

This skill module provides a standardised interface for integrating AI-powered
`performance review` capabilities into any agent workflow.
...
```markdown
# Skill: Performance Review Skill v1.0
...
```
You are a specialised AI skill module for performance review.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for performance review.
...
Save as `.claude/skills/skill-performance-review-pro.md` and invoke with `/performance-review-pro`
...
```json
{
  "product_id": "AA-SKL-HRE-PERFREV-PRO-086",
  "skill_name": "Performance Review Skill",
  "version": "1.0.0",
  "category": "skill",
