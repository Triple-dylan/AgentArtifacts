...
**Product ID:** `AA-SKL-CSX-HEALTHSCORE-169`  
...
Builds composite health scores from product usage, NPS, support tickets, and contract data

This skill module provides a standardised interface for integrating AI-powered
`customer health score` capabilities into any agent workflow.
...
```markdown
# Skill: Customer Health Score Skill v1.0
...
```
You are a specialised AI skill module for customer health score.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for customer health score.
...
Save as `.claude/skills/skill-customer-health-module.md` and invoke with `/customer-health-module`
...
```json
{
  "product_id": "AA-SKL-CSX-HEALTHSCORE-169",
  "skill_name": "Customer Health Score Skill",
  "version": "1.0.0",
  "category": "skill",
