# Risk Check Skill
**Product ID:** `AA-SKL-TRD-RISKCHECK-PRO-022`  
...
Risk controls for signal and order validation

This skill module provides a standardised interface for integrating AI-powered
`risk check` capabilities into any agent workflow.
...
```
You are a specialised AI skill module for risk check.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for risk check.
...
Save as `.claude/skills/skill-trading-risk-check.md` and invoke with `/trading-risk-check`
...
```json
{
  "product_id": "AA-SKL-TRD-RISKCHECK-PRO-022",
  "skill_name": "Risk Check Skill",
  "version": "1.0.0",
  "category": "skill",
