# OpenAPI Spec Builder Utility
**Product ID:** `AA-UTL-WEB-OPENAPI-116`  
...
Utility for auto-generating validated OpenAPI 3.1 specs from route handlers and type annotations
...
```json
{
  ...
  "title": "OpenAPI Spec Builder Utility",
  "description": "Utility for auto-generating validated OpenAPI 3.1 specs from route handlers and type annotations",
  "type": "object",
  "required": [
    "id",
    "type",
...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "OpenAPI Spec Builder Utility Config",
  "type": "object",
  "properties": {
    "enabled": {
      "type": "boolean",
