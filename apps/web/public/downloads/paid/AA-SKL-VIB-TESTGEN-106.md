# Automated Test Generator Skill
**Product ID:** `AA-SKL-VIB-TESTGEN-106`  
...
Generates unit, integration, and edge-case tests from existing code with coverage reports

This skill module provides a standardised interface for integrating AI-powered
`automated test generator` capabilities into any agent workflow.
...
```markdown
# Skill: Automated Test Generator Skill v1.0
...
```
You are a specialised AI skill module for automated test generator.
...
SKILL_SYSTEM_PROMPT = """You are a specialised AI skill module for automated test generator.
...
Save as `.claude/skills/skill-test-generator-module.md` and invoke with `/test-generator-module`
...
```json
{
  "product_id": "AA-SKL-VIB-TESTGEN-106",
  "skill_name": "Automated Test Generator Skill",
  "version": "1.0.0",
  "category": "skill",
